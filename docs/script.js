const translations = {
  en: {
    ...
    faqAlternativeQuestion: "Is it an alternative to LaunchControl or a launchd manager?",
    faqAlternativeAnswer: "Yes. LaunchAgent Studio provides a focused interface for common user-level LaunchAgent tasks. It is not affiliated with LaunchControl or other launchd management products.",
  ...
  zh: {
    ...
    faqAlternativeQuestion: "可以作为 LaunchControl 或 launchd 管理器的替代工具吗？",
    faqAlternativeAnswer: "可以。LaunchAgent Studio 为常见的用户级 LaunchAgent 任务提供集中管理界面。本项目与 LaunchControl 或其他 launchd 管理产品没有关联。",
